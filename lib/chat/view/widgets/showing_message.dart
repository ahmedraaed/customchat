...
Widget ShowingMessage({
  ...
  if (messageType == "image") {
    return InkWell(
        onTap: ()async{
          final Uri _url = Uri.parse("$baseUrl${chatCubit.listMessage[index].file}");
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image:chatCubit.listMessage[index].file!
                  ...
                  ? DecorationImage(
                fit: BoxFit.fill,
                image:  NetworkImage(baseUrl+ chatCubit.listMessage[index].file!,),
              ): DecorationImage(
                fit: BoxFit.fill,
    ...
    return InkWell(
      onTap: () async {
       ...
       print("$baseUrl${chatCubit.listMessage[index].file}");
          ...
          builder:(context, value, child) {
            return Directionality(
              ...
              VoiceMessage(
                ...
                audioSrc: "$baseUrl${chatCubit.listMessage[index].file!}",
